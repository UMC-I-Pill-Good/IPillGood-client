export const TOAST_MESSAGES = {
  SEARCH_FETCH_FAILED: '검색 결과를 불러오지 못했어요. 다시 시도해 주세요.',
  CART_ADDED: '담았어요!',
  SUPPLEMENT_ADDED: '섭취 중인 영양제에 추가됐어요!',
  ...
  REPORT_SUBMITTED: '신고가 접수됐어요.',
  REPORT_SUBMIT_FAILED: '신고 접수에 실패했어요. 다시 시도해 주세요.',
} as const;
