...
export const SearchBar = ({ value, onChange, onSearch, placeholder }: SearchBarProps) => {
  ...
  return (
    <div className='flex h-10 w-full items-center justify-between rounded-[10px] bg-primary-300 px-3 py-2.5 shadow-[0px_4px_4px_0px_rgba(126,131,135,0.10)] backdrop-blur-xs'>
      <input
        value={value}
