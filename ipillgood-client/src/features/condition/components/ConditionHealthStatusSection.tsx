...
const ConditionHealthStatusSection = () => {
    ...
    return (
        <section className='flex w-full flex-col px-5 py-4'>
            <div
                className={clsx(
                    'glass !h-auto !w-full !flex !flex-col items-center justify-center gap-3 overflow-hidden rounded-[20px] px-3 pt-3.5 pb-3',
                    '!bg-primary-600/35',
                    'shadow-[0_4px_4px_0_rgba(126,131,135,0.1)]',
                )}
            >
                <div className='flex w-full flex-col items-center gap-1'>
                    <h2 className='typo-title-gosanja w-full text-center text-base font-normal not-italic leading-none text-black'>
                        궁금한 건강 상태가 있으신가요?
                    </h2>
