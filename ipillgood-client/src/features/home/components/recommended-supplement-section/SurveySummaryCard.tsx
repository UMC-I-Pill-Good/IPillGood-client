...
const SurveySummaryCard = ({ healthSummary }: SurveySummaryCardProps) => {
  return (
    <div className='min-h-40.5 relative flex flex-col gap-1 py-2 px-4 rounded-[20px] home-card-glass overflow-hidden'>
      <p className='text-black typo-caption-2'>설문 기반 건강 상태 요약</p>
      <div className='w-[75%] text-neutral-800 typo-caption-3 leading-4.5!'>{healthSummary}</div>
