...
const IngredientSummaryCard = ({ name, imageUrl, description }: IngredientSummaryCardProps) => {
  return (
    <section
      className='flex items-center gap-4 pl-7.5 pr-9.5 py-6 bg-linear-[135deg] from-[#4680fe]/25 to-[#4680fe]/30 rounded-[20px] shadow-[0px_4px_4px_0px_rgba(126,131,135,0.1),inset_-2px_-2px_3px_0px_rgba(0,0,0,0.04)]
'
    >
